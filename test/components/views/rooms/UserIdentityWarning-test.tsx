...
describe("UserIdentityWarning", () => {
    ...
    it("displays a warning when a user's identity needs approval", async () => {
        ...
        await waitFor(() =>
            expect(
                screen.getByText("Alice's (@alice:example.org) identity appears to have changed."),
            ).toBeInTheDocument(),
        );
    ...
    it("displays pending warnings when encryption is enabled", async () => {
        ...
        expect(() => screen.getByText("Alice's (@alice:example.org) identity appears to have changed.")).toThrow();
    ...
    it("displays the next user when the current user's identity is approved", async () => {
        ...
        await waitFor(() =>
            expect(screen.getByText("@bob:example.org's identity appears to have changed.")).toBeInTheDocument(),
        );
    });
